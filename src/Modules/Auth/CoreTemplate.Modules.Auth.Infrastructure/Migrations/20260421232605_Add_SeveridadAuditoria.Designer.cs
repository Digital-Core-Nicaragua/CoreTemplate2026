...
namespace CoreTemplate.Modules.Auth.Infrastructure.Migrations
{
    ...
    [Migration("20260421232605_Add_SeveridadAuditoria")]
    partial class Add_SeveridadAuditoria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreTemplate.Modules.Auth.Domain.Aggregates.Accion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CoreTemplate.Modules.Auth.Domain.Entities.ConfiguracionTenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("MaxSesionesSimultaneas")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ConfiguracionesTenant", "Auth");
                });
                    ...
                    b.OwnsOne("CoreTemplate.Modules.Auth.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                            ...
                            b1.HasKey("UsuarioClienteId");

                            b1.HasIndex("Valor")
                                .HasDatabaseName("IX_UsuariosCliente_Email");

                            b1.ToTable("UsuariosCliente", "Auth");
